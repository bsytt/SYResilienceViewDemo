...
let sy_sliderDefaultWidth: CGFloat = 40.010101010

public class SYLayout: NSObject {
    
    /* pageView背景颜色 */
    @objc public var titleViewBgColor: UIColor? = .white
    
    /* 标题颜色，请使用RGB赋值 */
    @objc public var titleColor: UIColor? = .gray9Color
    
    /* 标题选中颜色，请使用RGB赋值 */
    @objc public var titleSelectColor: UIColor? = .themeColor
    
    /* 标题字号 */
    @objc public var titleFont: UIFont? = .systemFont(ofSize: 16)
    
    /* 滑块底部线的颜色 - UIColor.blue */
    @objc public var bottomLineColor: UIColor? = .themeColor
    
    /* 整个滑块的高，pageTitleView的高 */
    @objc public var sliderHeight: CGFloat = 44.0
    
    /* 单个滑块的宽度, 一旦设置，将不再自动计算宽度，而是固定为你传递的值 */
    @objc public var sliderWidth: CGFloat = sy_sliderDefaultWidth
    ...
    /* 是否悬停 默认为true开启悬停 此属性仅对SYSimpleManager有效 关闭时记得修改viewControll的frame*/
